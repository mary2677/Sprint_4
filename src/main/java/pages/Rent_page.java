...
public class Rent_page {
    ...
    /** Конструктор класса */
    public Rent_page(WebDriver driver) {
        this.driver = driver;
    }

    /** <b>Методы для работы с элементами страницы аренды</b>
     * <p>Ввод даты доставки*/
    public Rent_page sendRentalDate(String date) {
    ...
    /** Ввод срока аренды*/
    public Rent_page setRentalTime() {
